...
!mass and their derivatives
  ...
  ms2o=ms2
  if(abs(ms2-mp2)<1.Q-10*(ms2+mp2)/2.)then
    ms2=mp2+1.Q-7*(ms2+mp2)/2.
  end if
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  etaphi=(4.Q+00/k**2*kappa*lam2**2*b2b2PS+Nc*h**2*(-3*f2a+8*f3a))/(6.Q+00*pi**2)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  write(*,*)'k=',k*hc
  open(unit=97,file='./buffer/mf2.dat')
  write(97, "(e20.9)")mf2*k**2

  open(unit=98,file='./buffer/ms2.dat')
  write(98, "(e20.9)")ms2*k**2

  open(unit=99,file='./buffer/mp2.dat')
  write(99, "(e20.9)")mp2*k**2

  open(unit=100,file='./buffer/Zphi.dat')
  write(100, "(e20.9)")Zphi
