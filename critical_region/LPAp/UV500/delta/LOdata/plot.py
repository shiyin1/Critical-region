...
ax1.plot(mub530data[:,0],mub530data[:,1],'-',c='#9C9CC0',linewidth=2.5,alpha=1.,label=r'$\mu_B=530\,\mathrm{MeV}$')
...
ax1.text(10**-1,4.2,r'$\mathrm{LPA}^\prime$',fontsize=15)
ax1.set_xscale('log')
...
ax1.legend(loc=0,bbox_to_anchor=(0.3, 0.5),fontsize=9.5,frameon=False,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,scatterpoints=1)
