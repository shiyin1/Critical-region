...
mub530data=np.loadtxt('./mub530.dat')
delta=4.79
# Create figure
...
ax1.plot(mub450data[:,0],mub450data[:,1],'-',c='#CEA2B5',linewidth=2.5,alpha=1.,label=r'$\mu_B=450\,\mathrm{MeV}$')
ax1.plot(mub500data[:,0],mub500data[:,1],'-',c='#9C9CC0',linewidth=2.5,alpha=1.,label=r'$\mu_B=500\,\mathrm{MeV}$')
ax1.plot(mub530data[:,0],mub530data[:,1],'-',c='#6F8BB8',linewidth=2.5,alpha=1.,label=r'$\mu_B=530\,\mathrm{MeV}$')
...
ax1.text(10**-2,4.3,r'$\mathrm{LPA}^\prime$',fontsize=15)
ax1.set_xscale('log')
ax1.axis([2*10**-4,300,2.,6.5])
...
ax1.legend(loc=(0.21, 0.01),fontsize=9.5,frameon=False,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,scatterpoints=1)
