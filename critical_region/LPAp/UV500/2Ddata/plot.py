...
ax1.plot(mub,beta0p37,'-',c='#FDDFD0',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;order\;parameter}=0.37$')
ax1.plot(mub,beta0p38,'-',c='#FC9171',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;order\;parameter}=0.38$')
ax1.plot(mub,beta0p39,'-',c='#EE3B2A',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;order\;parameter}=0.39$')
