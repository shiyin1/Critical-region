...
beta0p39=np.loadtxt('./beta0p39.dat')
...
ax1.plot(mub,nu0p01,'-',c='#206FB6',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;correlation\;length}=\pm 1\%\nu$')
ax1.plot(mub,nu0p02,'-',c='#6BADD7',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;correlation\;length}=\pm 2\%\nu$')
ax1.plot(mub,nu0p03,'-',c='#C5DAEE',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;correlation\;length}=\pm 3\%\nu$')
ax1.plot(mub,beta0p37,'-',c='#FDDFD0',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;order\;parameter}=0.39$')
ax1.plot(mub,beta0p38,'-',c='#FC9171',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;order\;parameter}=0.38$')
ax1.plot(mub,beta0p39,'-',c='#EE3B2A',linewidth=.5,alpha=1.,label=r'$\mathrm{Slope\;of\;order\;parameter}=0.37$')
...
ax1.fill_betweenx([0,200],[530,530],[1000,1000],color='gray',edgecolor='none',alpha=0.3,zorder=10)
ax1.plot(pb2nd[0:54,0],pb2nd[0:54,1]+0.5,'-',c='k',linewidth=1.5,alpha=1.,label=r'$\mathrm{2nd-Phase\;boundary}$')
#ax1.set_xscale('log')
ax1.text(270,110,r'$\mathrm{LPA}^\prime$',fontsize=15)
ax1.axis([0,600,45,120])
...
fig.savefig("beta_nu_phase_LPAp.pdf")
