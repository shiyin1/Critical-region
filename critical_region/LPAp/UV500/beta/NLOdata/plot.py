...
NLOdatamub500=np.loadtxt('./NLObetamub500.dat')
...
ax1.plot(np.exp(LOdatamub500[:,0]),LOdatamub500[:,1],dashes=[2,1],c='#478ecc',linewidth=2.5,alpha=1.,label=r'$\mathrm{LO}\,\,\mu_B=500\,\mathrm{MeV}$')
...
ax1.text(2*10**-5,0.404,r'$\mathrm{LPA}^\prime$',fontsize=15)
ax1.set_xscale('log')
ax1.axis([6*10**-6,2.5*10**-2,0.37,0.43])
