...
mub600data=np.loadtxt('./mub530.dat')
beta=0.3973562167735344914593465227064
# Create figure
...
ax1.fill_betweenx([0,1],[10**-6,10**-6],[0.005/500,0.005/500],color='red',edgecolor='none',alpha=0.3,zorder=10)
ax1.text(2*10**-5,0.387,r'$\mathrm{LPA}^\prime$',fontsize=15)
ax1.set_xscale('log')
ax1.axis([6*10**-6,2.5*10**-2,0.35,0.42])
