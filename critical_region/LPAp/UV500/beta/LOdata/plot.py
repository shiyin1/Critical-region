...
ax1.text(3*10**-5,0.385,r'$\mathrm{LPA}^\prime$',fontsize=15)
ax1.set_xscale('log')
...
ax1.legend(loc=0,bbox_to_anchor=(0.5, 0.5),fontsize=9.5,frameon=False,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,scatterpoints=1)
