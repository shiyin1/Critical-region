...
!make the initialization
  ...
  lambda=11.Q+0
  nu=(830.Q+0/hc)**2
  h=10.18Q+0!expansion coefficients of Yukawa coupling
  !c=2.82Q-3*(1000.Q+0/hc)**3  !explicit chiral symmetry breaking term, in unit of fm**(-3)
  c=cl!5.Q-11!2.82Q-3*(1000.Q+0/hc)**3  !explicit chiral symmetry breaking term, in unit of fm**(-3)
