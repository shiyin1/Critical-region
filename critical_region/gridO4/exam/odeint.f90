...
!/path/ contains its own information about how often an intermediate value is to be stored.
  ...
  PARAMETER (MAXSTP=600000,NMAX=600,KMAXX=1000,TINY=1.Q-30)
  INTEGER kmax,kount
  INTEGER i,nstp
  real(16) dxsav,h,hdid,hnext,x,xsav,dydx(NMAX),xp(KMAXX),y(NMAX),yp(NMAX,KMAXX),yscal(NMAX)
  real(16) funp(10,KMAXX),funsave(10)
...
!    USES derivs,rkck
  ...
  PARAMETER (SAFETY=0.9Q+00,PGROW=-0.2Q+00,PSHRNK=-0.25Q+00,ERRCON=1.89D-4)
  h=htry
