subroutine expaPoint(Nflow,yflow,kappa_UV)
  ...
  real(16) kappa_UV, kappa_old, kappa_new
  real(16) T,mu
...
!    rho0_gaug=rho0*(1.+epsi_rho0)
    ...
    write(*,"('delta_IR=', f15.13)")delta_IR
    write(*,"('abs(delta_IR)/kappa=', f15.13)")abs(delta_IR)/kappa
