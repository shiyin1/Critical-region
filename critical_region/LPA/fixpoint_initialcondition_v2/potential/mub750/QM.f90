...
!order of chebyshev polynomial
  ...
  real(16) lam1,lam2,lam3,lam4,lam5,lam0
  external chebev
  ...
  common /iTiv/ iT,iv
  common /break/ cl
  common /physCom/ lam1,lam2,lam3,lam4,lam5,lam0
...
!  Tc=91.74873Q+00
  ...
  do i=1,1!iTmax
    ...
    open(unit=51,file='./buffer/lam0.dat',position='append')
    write(51,*)lam0
    close(51)

    open(unit=51,file='./buffer/lam1.dat',position='append')
    write(51,*)lam1
    close(51)

    open(unit=51,file='./buffer/lam2.dat',position='append')
    write(51,*)lam2
    close(51)

    open(unit=51,file='./buffer/lam3.dat',position='append')
    write(51,*)lam3
    close(51)

    open(unit=51,file='./buffer/lam4.dat',position='append')
    write(51,*)lam4
    close(51)

    open(unit=51,file='./buffer/lam5.dat',position='append')
    write(51,*)lam5
    close(51)
