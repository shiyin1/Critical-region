...
LOdatamub550=np.loadtxt('./LOmub550.dat')
NLOdatamub550=np.loadtxt('./NLOdeltamub550.dat')
#NLOdata[0:23,1]=NLOdata[24,1]
NLOdata[25:43,1]=NLOdata[44,1]
NLOdata[45:53,1]=NLOdata[54,1]
NLOdatamub550[45:48,1]=NLOdatamub550[49,1]
delta=5.
# Create figure
...
ax1.plot(LOdatamub550[:,0],LOdatamub550[:,1],dashes=[2,1],c='#478ecc',linewidth=2.5,alpha=1.,label=r'$\mathrm{LO}\,\,\mu_B=550\,\mathrm{MeV}$')
