...
!order of chebyshev polynomial
  ...
  do i=1,20!iTmax
    ...
    !  T_MeV=Tc
    !else
      T_MeV=Tc-real((i-1)*1.Q-8,kind=16)!-exp((tc1)+((-tc1)-(-t2))/iTmax*real((i-1),kind=16))*Tc
    !end if
!    cl=1.Q-8/hc**3
    cl=0.Q+00
    T=T_MeV/hc
    ...
    write(*,"('i=', I4)")i
    write(*,"('muB_MeV=', f15.7, t25, 'T_MeV=', f15.10)")muB_MeV,T_MeV
    write(*,"('fpi=', f15.7, t25, 'mPion=', f15.10)")fpi*hc,mPion*hc
    write(*,"('mf=', f15.7, t25, 'mSigma=', f15.10)")mf*hc,mSigma*hc
