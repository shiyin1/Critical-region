...
! muBi=706.4682244963Q+0/hc
!  muBi=706.46821Q+0/hc
  muBi=706.468218Q+0/hc
...
! Tc=49.67994700791Q+00
  ...
  do i=1,1!iTmax
    !if(i==1)then
      T_MeV=Tc
    !else
    !  T_MeV=Tc-real((i-1)*1.Q-10,kind=16)!-exp((tc1)+((-tc1)-(-t2))/iTmax*real((i-1),kind=16))*Tc
    !end if
    cl=0.Q+00
    T=T_MeV/hc
    ...
    write(*,"('i=', I4)")i
    write(*,"('T_MeV=', f16.12, t25, 'm_pion=', f16.12)")T_MeV,mPion*hc
