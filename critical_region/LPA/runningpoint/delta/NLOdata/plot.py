...
mub0data=np.loadtxt('./mub0data.dat')
mub50data=np.loadtxt('./mub50data.dat')
mub100data=np.loadtxt('./mub100data.dat')
mub150data=np.loadtxt('./mub150data.dat')
mub200data=np.loadtxt('./mub200data.dat')
mub250data=np.loadtxt('./mub250data.dat')
mub300data=np.loadtxt('./mub300data.dat')
mub350data=np.loadtxt('./mub350data.dat')
mub400data=np.loadtxt('./mub400data.dat')
mub450data=np.loadtxt('./mub450data.dat')
mub500data=np.loadtxt('./mub500data.dat')
mub550data=np.loadtxt('./mub550data.dat')
mub600data=np.loadtxt('./mub600data.dat')
mub650data=np.loadtxt('./mub650data.dat')
mub700data=np.loadtxt('./mub700data.dat')
...
ax1.plot(mub600data[:,0],mub600data[:,1],'-',c='#9C9CC0',linewidth=2.5,alpha=1.,label=r'$\mu_B=600\,\mathrm{MeV}$')
ax1.plot(mub650data[:,0],mub650data[:,1],'-',c='#6F8BB8',linewidth=2.5,alpha=1.,label=r'$\mu_B=650\,\mathrm{MeV}$')
ax1.plot(mub700data[:,0],mub700data[:,1],'-',c='#59649D',linewidth=2.5,alpha=1.,label=r'$\mu_B=700\,\mathrm{MeV}$')
ax1.plot([10**-4,10**4],[5,5],dashes=[2,1],color='gray',linewidth=1.,alpha=0.6)
ax1.fill_between([10**-4,10**4],[5-0.1,5-0.1],[5+0.1,5+0.1],color='gray',edgecolor='none',alpha=0.3)
#ax1.text(221,1.2,r'$\mu=290\,\mathrm{MeV}$',fontsize=10)
ax1.set_xscale('log')
ax1.axis([6*10**-3,500,3.0,6.0])

ax1.set_xlabel(r'$m_\pi\,[\mathrm{MeV}]$', fontsize=14, color='black')
ax1.set_ylabel(r'$\mathrm{Leading\,\,order\,\,Fit}$', fontsize=14, color='black')
