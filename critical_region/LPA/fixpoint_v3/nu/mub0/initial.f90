...
!expansion coefficients of Yukawa coupling
  ...
  c=9.Q-8!1.75Q-3*(1000.Q+0/hc)**3  !explicit chiral symmetry breaking term, in unit of fm**(-3)
!  c=0.Q+00!1.75Q-3*(1000.Q+0/hc)**3  !explicit chiral symmetry breaking term, in unit of fm**(-3)
