...
!expansion coefficients of Yukawa coupling
  ...
  c=0.Q+00!1.7Q-3*(1000.Q+0/hc)**3  !explicit chiral symmetry breaking term, in unit of fm**(-3)

  !kappa=0.Q+00

  lam0=(kappa**3*lambda2)/6.Q+0+(kappa**2*lambda)/2.Q+0+nu*kappa
  lam1=(kappa**2*lambda2)/2.Q+0+kappa*lambda+nu
  lam2=kappa*lambda2+lambda
  lam3=lambda2
