subroutine phyphi(yflow,V0,imin)
  ...
  integer(8) gridnum
  real(16) drho,rho(Vmax),yflow(Nflow),rhonew(100000),rhomin,rhomax
...
!  V0=V0-cbar*sqrt(2.Q+00*rho)
  ...
  open(unit=50,file='./buffer/a.dat',position='append')
  do i=1,gridnum
  write(50,*) a(i)
  end do
  close(50)
  ...
  close(50)
  open(unit=50,file='./buffer/V.dat',position='append')
  do i=1,maxim
  write(50,*) V0(i)
  end do
  close(50)
  ...
  close(50)
  open(unit=50,file='./buffer/rhonew.dat')
  do i=1,maxim
  write(50,*) rhonew(i)
  end do
  close(50)
  ...
  open(unit=50,file='./buffer/dVd1rho.dat',position='append')
  write(50,*) V1(1)
  close(50)
end
