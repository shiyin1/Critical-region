...
!make the initialization
  ...
  !lami3=3.33123Q+00*10Q-72 !anum=21 old
  lami3=3.Q+00*10Q-225 !anum=51

  kappa=rho
  yflow=0.Q+00
  yflow(1:gridnum)=lami1*kappa+lami2*kappa**2/2.Q+00+lami3*kappa**50.Q+00
