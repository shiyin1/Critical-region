...
!Calculating the Chebyshev coefficient
  ...
  common /gridrho/ gridnum,rho,rhomin,rhomax
  common /chebyshev/ Tn,b,c

  k=x
  a(1:gridnum)=y(1:gridnum)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  call chder(rhomin,rhomax,a,b,gridnum)
  call chder(rhomin,rhomax,b,c,gridnum)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
